"""Ising model Hamiltonian implementation for PennyLane."""
...
class IsingHamiltonian:
    ...
    def build_hamiltonian(self):
        """
        Build the Ising Hamiltonian as a PennyLane Hamiltonian.

        Returns:
            PennyLane Hamiltonian observable
        """
        coeffs = []
        obs = []
    ...
    def get_hamiltonian(self):
        """Get the Hamiltonian observable."""
